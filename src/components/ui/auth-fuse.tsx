    ...
    <form onSubmit={handleSignIn} autoComplete="on" className="flex flex-col gap-8">
      ...
      <div className="grid gap-4">
        <div className="grid gap-2">
          <Label htmlFor="fuse-email">Email</Label>
          <Input id="fuse-email" name="email" type="email" placeholder="m@example.com" required autoComplete="email" onChange={clearError} />
        </div>
        <PasswordInput name="password" label="Password" required autoComplete="current-password" placeholder="Password" onChange={clearError} />
    ...
    <form onSubmit={handleSignUp} autoComplete="on" className="flex flex-col gap-8">
      ...
      <div className="grid gap-4">
        <div className="grid gap-1">
          <Label htmlFor="fuse-name">Full Name</Label>
          <Input id="fuse-name" name="name" type="text" placeholder="John Doe" required autoComplete="name" onChange={clearError} />
        </div>
        <div className="grid gap-2">
          <Label htmlFor="fuse-signup-email">Email</Label>
          <Input id="fuse-signup-email" name="email" type="email" placeholder="m@example.com" required autoComplete="email" onChange={clearError} />
        </div>
        <PasswordInput name="password" label="Password" required autoComplete="new-password" placeholder="Password" onChange={clearError} />
        <Button type="submit" variant="outline" className="mt-2" disabled={isSubmitting}>
...
const defaultSignInContent = {
  ...
  quote: { text: "Welcome Back! The journey continues.", author: "ConceptIQ" },
};
...
const defaultSignUpContent = {
  ...
  quote: { text: "Create an account. A new chapter awaits.", author: "ConceptIQ" },
};

export function AuthUI({ signInContent = {}, signUpContent = {}, initialView = "signin" }: AuthUIProps) {
